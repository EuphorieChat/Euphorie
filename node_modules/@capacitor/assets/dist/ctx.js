...
async function loadContext(projectRootPath) {
    ...
    let project;
    try {
        project = await loadProject(projectRootPath, (_a = argv.assetPath) !== null && _a !== void 0 ? _a : 'assets');
    }
    catch (e) {
...
async function loadProject(projectRootPath, projectAssetPath) {
...
function loadMobileProjectConfig() {
    return {
        ios: {
            path: 'ios/App',
        },
