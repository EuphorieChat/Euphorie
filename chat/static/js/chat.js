document.addEventListener("DOMContentLoaded", function () {
    ...
    // *** Make socket globally accessible to fix the reference error ***
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', () => {
        // Update active state
        filterBtns.forEach(b => b.classList.replace('bg-pink-500', 'bg-gray-200'));
